...
| **7** weights | Thin, Ultralight, Light, Regular, Medium, Semibold, Bold — every icon, every weight |
| **2** styles | stroke throughout; fill on 954 icons where a solid form reads well |
| **14 942** shapes | 9 086 stroke and 5 856 fill |
