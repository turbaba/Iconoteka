...
```
https://cdn.jsdelivr.net/gh/turbaba/Iconoteka@02.00.13/Icons/Interface/bell-notification-notify-reminder-ring-sound-r-s.svg
```
...
```
https://cdn.jsdelivr.net/gh/turbaba/Iconoteka@02.00.13/icons.json
```
